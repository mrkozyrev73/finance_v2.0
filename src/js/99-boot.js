...
function boot() {
  ...
  // После нового запуска всегда начинаем с главной страницы. Последняя
  // вкладка больше не восстанавливается: так приложение открывается
  // предсказуемо после закрытия и повторного запуска.
